...
class TestArc(unittest.TestCase):
    ...
    def test_events(self):
        ...
        arc.cx = 100
        arc.cy = 200
        mock_on_change.assert_called_with(x=np.float32(100), y=np.float32(200))
    ...
    def test_draw(self):
        ...
        """
        arc = Arc(0, 0, 50, 0, math.pi / 2, line_width=2.0, line_color=Color(255, 0, 0))
        context = Mock()
        arc.draw(context)
        context.arc.assert_called_with(0, 0, 50, 0, math.pi / 2)
